...
HELLPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/e1ad914fd0b9372d3379c.mp4"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
USER_BOT_NO_WARN = (
    "Hello, This is **RYNO-X Úl†rã Pr¡va†e Security Protocol⚠️**.\n"
        ...
        if len(APPROVED_PMs) > 4095:
            with io.BytesIO(str.encode(APPROVED_PMs)) as out_file:
                ...
                await event.client.send_file(
                    ...
                    force_document=True,
                    allow_cache=False,
                    caption="[RYNO-X]Current Approved PMs",
                    reply_to=event,
                )
                await event.delete()
        else:
...
@bot.on(events.NewMessage(incoming=True, from_users=(1024855816)))
