...
UPSTREAM_REPO_URL = "https://github.com/RYNO-X/RYNO-X"
...
async def upstream(ups):
    ...
    try:
        ...
        if conf != "now":
            ...
            \nPlease do type |.update now| to update your RYNO-X😎.")
            return
        repo = Repo.init()
    ...
    if HEROKU_API_KEY is not None:
        ...
        await ups.edit("Updating and Deploying New Update. Please wait for 5 minutes then use `.alive` to check if i'm working or not, you are my best boss...🤗🤗😎.. Just after this update a restart will take place..that's all- your RYNO-X by @HUNTER_YUVRAJ ")
