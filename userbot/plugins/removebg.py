...
async def _(event):
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "RYNO-X_RM_BG.png"
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by @OFFICIALRYNOX ©™".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @OFFICIALRYNOX\n`{}".format(output_file_name.content.decode("UTF-8")))
