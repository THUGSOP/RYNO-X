...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("RYNO-X: Preparing to gban user....")
        ...
        await event.edit("RYNO-X: Gbanned user successfully in 204 chats.\nBlocked and added to gban watch!")
...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("RYNO-X: Preparing to Ungban user....")
        await asyncio.sleep(2)
        ...
        await event.edit("UnGbanning user... \n 204 chats")
        await asyncio.sleep(1.5)
        await event.edit("RYNO-X: UnGbanned user successfully in 204 chats.\nUnBlocked and removed from gban watch")
